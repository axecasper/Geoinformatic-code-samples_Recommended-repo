x=[5 1000 1000 18 194 -23 247 257 596 770   412 725 462 327 900] ;
y=[82 118 931 1000 249 721 1119 855 531 362   840 866 609 315 1073];
z=[320 400 420 390 303.5 422.3 445 447.8 423.9 405.1   430 405 400 330 420];

bx=[412 725 462 327 900];
by=[840 866 609 315 1073];
bz=[430 405 400 330 420];
